// HeroSection.tsx - Three.js Cosmic Hero for Meraz Festival
...
export const HorizonHeroSection = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Update nebula
      if (refs.nebula) {
        const nebulaUniforms = (refs.nebula.material as THREE.ShaderMaterial).uniforms;
        if (nebulaUniforms) {
          nebulaUniforms.time.value = time * 0.5;
        }
      }
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            IIT Bhilai's Premier Cultural Festival
          </p>
          <p className="subtitle-line">
            Where Stars Align & Dreams Take Flight
          </p>
        </div>
      </div>
      ...
      <div className="scroll-sections">
        {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string }> = {
            0: {
              line1: 'IIT Bhilai\'s Premier Cultural Festival',
              line2: 'Where Stars Align & Dreams Take Flight'
            },
            1: {
              line1: 'Discover extraordinary performances,',
              line2: 'competitions, and cultural celebrations'
            },
            2: {
              line1: 'Join thousands in a cosmic journey',
              line2: 'of art, music, dance, and innovation'
            }
          };
