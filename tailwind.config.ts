...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-cosmic": "linear-gradient(135deg, hsl(var(--primary) / 0.8), hsl(var(--secondary) / 0.8))",
        "gradient-radial": "radial-gradient(ellipse at center, hsl(var(--primary) / 0.15), transparent 70%)",
      },
    },
  },
